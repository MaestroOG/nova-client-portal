                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td style="text-align:right;vertical-align:middle;">
                      <!-- small badge -->
                      <span style="display:inline-block;background:#430D4B;color:#fff;font-size:12px;padding:6px 10px;border-radius:999px;font-weight:600;">Admin Alert</span>
                    </td>
                  </tr>
                </table>
              </td>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <td style="padding:10px 8px;border-bottom:1px dashed #e6eef6;">
                            <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;">
                              <div style="flex:1;">
                                ...
                                <div style="font-size:13px;color:#6b7280;margin-top:4px;">Service — Last note: Oct 24, ${new Date().getFullYear()} (or None)</div>
                              </div>
                  ...
                  <tr>
                    <td style="padding-top:18px;text-align:center;">
                      <a href="https://your-app.example.com/admin/projects" target="_blank" style="display:inline-block;padding:12px 20px;border-radius:10px;background:#430D4B;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;">Open Admin Dashboard</a>
                    </td>
                  </tr>
