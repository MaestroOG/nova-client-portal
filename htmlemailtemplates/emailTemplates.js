    ...
    <tr>
      <td style="padding:40px 30px;">
        ...
        <p style="font-size:16px; line-height:1.6; margin-top:15px;">
          We're excited to let you know that your request for a <strong>partnership with Nova Protocols</strong> has been <span style="color:green; font-weight:bold;">accepted ${!creditAmount && creditAmount > 0 && `and a credit of ${creditAmount} has been allotted`}.
        </p>
        <!-- New credit line -->
