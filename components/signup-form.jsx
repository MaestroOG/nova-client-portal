                ...
                <div className="grid gap-6">
                    ...
                    {step === 90 && (
                        <>
                            ...
                            <div className="grid gap-3">
                                <Label htmlFor="monthlyProjectVolume" className={'text-heading'}>Anticipated Monthly Project Volume for Nova Protocols (Optional)</Label>
                    ...
                    <div className="text-center text-sm dark:text-background">
                        Already a user?{" "}
