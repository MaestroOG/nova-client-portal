        ...
        <Container className={'bg-white p-4 rounded-lg'}>
            ...
            <div className='mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                ...
                {discussions && discussions?.map((discussion) => {
                    ...
                    return (
                        <div key={discussion?._id} className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                            <div className='flex items-center justify-between'>
                            ...
                            <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 flex items-center gap-2">
                                {discussion.title}
                                {count > 0 && (
