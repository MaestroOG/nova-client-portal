        ...
        <div className='p-1 md:p-4'>
            ...
            <Tabs defaultValue="all" className="w-full">
                ...
                <TabsList className="grid grid-cols-3 gap-2 max-sm:grid-cols-1 w-full max-sm:mb-12">
                    <TabsTrigger
                        value="all"
                        className="data-[state=active]:bg-primary dark:data-[state=active]:bg-primary data-[state=active]:text-white"
                    >
                        All Resources
                    </TabsTrigger>
                ...
                <TabsContent value="all" className="mt-4">
                    ...
                    {resources.length === 0 && <p className="p-4 text-center text-muted-foreground">No Resources.</p>}
